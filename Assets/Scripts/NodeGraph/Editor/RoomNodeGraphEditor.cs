...
public class RoomNodeGraphEditor : EditorWindow
{
    ...
    /// <summary>
    /// Open the room node graph editor window if a room node hraph scriptable object asset is double clicked in the inspector
    /// </summary>
    ...
    private void CreateRoomNode(object mousePositionObject, RoomNodeTypeSO roomNodeType)
    {
        ...
        // add room node to the room node graph scriptable object asset database
